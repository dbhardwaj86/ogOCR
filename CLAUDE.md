...
> **🔁 Resuming work? Read [SESSION_HANDOFF.md](SESSION_HANDOFF.md) first** — start with the **Latest pass — v4 worksheet schema + unified Save picker (2026-04-27, commit `9c99826`)** section at the top.
>
...
## Latest changes (2026-04-27 — four sprints stacked: v4 Schema + Unified Save, Auto-Compile + Multi-SVG Export, Multi-Sketch Detection, Ship Cleanup)
