...
export const ERRORS = Object.freeze({
  ...
  OCR_NO_SKETCH_FOUND: entry('OCR_NO_SKETCH_FOUND', SURFACE.TOAST, SEVERITY.INFO,
    'No sketches detected in this document.',
    'Try a clearer scan, or upload a region that contains a hand-drawn diagram.'),
  OCR_SKETCH_BBOX_INVALID: entry('OCR_SKETCH_BBOX_INVALID', SURFACE.TOAST, SEVERITY.ERROR,
    'Bad sketch region.',
    'Refresh the page and try selecting the sketch again.'),
